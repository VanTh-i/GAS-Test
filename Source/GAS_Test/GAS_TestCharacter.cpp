...
#include "Character/Abilities/CharacterAttributeSet.h"
...
AGAS_TestCharacter::AGAS_TestCharacter()
{
	...
	MyAbilitySystemComponent = CreateDefaultSubobject<UAbilitySystemComponent>(TEXT("MyAbilitySystemComponent"));
...
void AGAS_TestCharacter::BeginPlay()
{
	...
	if (IsValid(MyAbilitySystemComponent))
	{
		BaseAttributeSet = MyAbilitySystemComponent->GetSet<UCharacterAttributeSet>();
	}
}
